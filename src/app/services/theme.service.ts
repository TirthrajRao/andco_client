...
export const origami = {
  ...
  'guest-activity-group-background' : '#0c89a4',
  'guest-activity-group-radio-check-color' : '#0c89a4',
  'guest-activity-tab-content-color' : '#0c89a4',
  'guest-total-add-more' : '#60a8bc',
  'circular-menu-floating-button-color' : '#60a8bc',
  'total-title-font-color' : '#ffffff',
  'total-title-background-color' : '#60a8bc',
  'group-box-h4-group' : '#000000',
  'activity-accordian-arrow-color' : '#ffffff',
  'next-skip-back-color' : '#a03245',
  'guest-address-radio-color': '#67aabf',
  'guest-address-label-color' : '#ffffff',
  'pay-by-color' : '#ffffff',
  'ussd-bg-color' : '#7a787896',
  'ussd-font-color' : '#ffffff',
